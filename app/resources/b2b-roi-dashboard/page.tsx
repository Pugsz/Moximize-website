...
const inside = [
  ...
  "Cost per lead and cost per opportunity by campaign",
  "Revenue attribution — first touch vs multi-touch",
  "Sales cycle length and conversion rate by stage",
  "Monthly recurring revenue (MRR) trend tracker",
  "Ready-to-import HubSpot reporting template",
];
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <h1 className="font-bold text-[clamp(28px,4vw,44px)] tracking-tight leading-[1.1] mb-5">
              B2B Marketing ROI Dashboard: Track What Actually Matters
            </h1>
            ...
            <div className="relative w-full aspect-[16/9] rounded-[16px] overflow-hidden mb-8 border border-[#242628]">
              <Image
                ...
                alt="B2B ROI analytics dashboard preview"
                fill
            ...
            <div className="flex items-center gap-3 text-[13px] text-[#72767a]">
              ...
              Written by the Moximize team · Revenue Operations Specialists
            </div>
          </div>
