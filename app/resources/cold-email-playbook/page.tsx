...
const inside = [
  "How to build a targeted prospect list in under 2 hours",
  "The 3-part email framework that gets 40%+ open rates",
  "AI-powered personalization at scale — first line formulas",
  "Follow-up sequencing: exactly what to send and when",
  "Deliverability setup: SPF, DKIM, DMARC made simple",
  "Real subject lines and email copy we use for clients",
];
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <h1 className="font-bold text-[clamp(28px,4vw,44px)] tracking-tight leading-[1.1] mb-5">
              Cold Email That Books Meetings: Our 3-Step Outbound System
            </h1>
            <p className="text-[16px] leading-[1.7] text-[#72767a] mb-8">
              The exact outbound system we run for B2B clients — from building a targeted prospect list to writing emails that actually get replies. No fluff, just the framework.
            </p>
            ...
            <div className="relative w-full aspect-[16/9] rounded-[16px] overflow-hidden mb-8 border border-[#242628]">
              <Image
                ...
                alt="Cold email outreach preview"
                fill
              ...
              <div className="absolute bottom-4 left-4 flex items-center gap-2">
                <span className="bg-[#29ABE2] text-black text-[11px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wide">Free Playbook</span>
                <span className="text-white text-[12px] font-medium opacity-90">40%+ open rate system</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-[13px] text-[#72767a]">
              ...
              Written by the Moximize team · AI-Powered Outbound Specialists
            </div>
          </div>
